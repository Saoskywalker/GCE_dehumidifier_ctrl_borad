 ...
 * @return 数据长度
 */
extern unsigned long my_strlen(unsigned char *str);
 ...
 * @return 待设置的内存首地址
 */
//extern void *my_memset(void *src,unsigned char ch,unsigned short count);
 ...
 * @return 数据处理完后的源地址
 */
extern void *my_memcpy(void *dest, const void *src, unsigned short count);
 ...
 */
extern unsigned long byte_to_int(const unsigned char value[4]);
 ...
 * @note   Null
 */
extern unsigned char mcu_dp_enum_update(unsigned char dpid,unsigned char value);
 ...
 * @note   Null
 */
extern unsigned char mcu_get_dp_download_bool(const unsigned char value[],unsigned short len);
 ...
 * @note   Null
 */
extern unsigned char mcu_get_dp_download_enum(const unsigned char value[],unsigned short len);
 ...
 * @note   Null
 */
extern unsigned long mcu_get_dp_download_value(const unsigned char value[],unsigned short len);
 ...
 */
extern unsigned char mcu_get_reset_wifi_flag(void);
 ...
 *         2:如果为模块自处理模式,MCU无须调用该函数
 */
extern unsigned char mcu_get_wifimode_flag(void);
 ...
 */
extern void mcu_set_wifi_mode(unsigned char mode);
 ...
 * @note   MCU需要自行调用该功能
 */
extern void mcu_get_wifi_connect_status(void);
#endif
