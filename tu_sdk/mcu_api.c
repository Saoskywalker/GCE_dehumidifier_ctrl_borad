...
{
    xdata unsigned short send_len = 0;
...
void wifi_uart_service(void)
{
    ...
    static xdata unsigned short rx_in = 0;
    xdata unsigned short offset = 0;
    xdata unsigned short rx_value_len = 0;
//    xdata unsigned short i;
	...
	/*
        else
        {
            ...
            {
                _logout(" %02bX",wifi_data_process_buf[i]);
            }
            _logout("\r\n"C_NONE);
        }
       */
