...
//=============================================================================
SYSTEM_EXTERN GCE_XDATA volatile unsigned char wifi_data_process_buf[PROTOCOL_HEAD + WIFI_DATA_PROCESS_LMT];     //串口数据处理缓存
SYSTEM_EXTERN GCE_XDATA volatile unsigned char wifi_uart_rx_buf[PROTOCOL_HEAD + WIFI_UART_RECV_BUF_LMT];         //串口接收缓存
SYSTEM_EXTERN GCE_XDATA volatile unsigned char wifi_uart_tx_buf[PROTOCOL_HEAD + WIFIR_UART_SEND_BUF_LMT];        //串口发送缓存
//
SYSTEM_EXTERN GCE_XDATA volatile unsigned char *rx_buf_in;
SYSTEM_EXTERN GCE_XDATA volatile unsigned char *rx_buf_out;

SYSTEM_EXTERN GCE_XDATA volatile unsigned char stop_update_flag;                                                 //ENABLE:停止一切数据上传  DISABLE:恢复一切数据上传

#ifndef WIFI_CONTROL_SELF_MODE
SYSTEM_EXTERN GCE_XDATA volatile unsigned char reset_wifi_flag;                                                  //重置wifi标志(TRUE:成功/FALSE:失败)
SYSTEM_EXTERN GCE_XDATA volatile unsigned char set_wifimode_flag;                                                //设置WIFI工作模式标志(TRUE:成功/FALSE:失败)
SYSTEM_EXTERN GCE_XDATA volatile unsigned char wifi_work_state;                                                  //wifi模块当前工作状态
#endif

#ifdef WIFI_STREAM_ENABLE
SYSTEM_EXTERN GCE_XDATA volatile unsigned char stream_status;                                                             //流服务发包返回状态
SYSTEM_EXTERN GCE_XDATA volatile unsigned char maps_stream_status;                                                        //多地图流服务发包返回状态
#endif
