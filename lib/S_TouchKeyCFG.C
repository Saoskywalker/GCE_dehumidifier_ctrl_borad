...
unsigned char  GetCfgMsg(unsigned char i)
{
    ...
    {
    case 0:
        return TKChannelCfg[0][SET_TOUCH_FREQ];
    case 1:
        return TKChannelCfg[0][SET_RESOLUTION];
    case 2:
        return TKChannelCfg[0][SET_GAIN_CFG];
    case 3:
        return GetBaseLineAdjustValue(0);//TKChannelCfg[0][SET_GAIN_CFG];
    case 4:
        return TKCFG[SET_ANTIJAM];
    default:
        return 0;
    }
}
